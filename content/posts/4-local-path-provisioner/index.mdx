...
# How Rancher's Local Path Provisioner works
...
![Storage provisioner](storage-provisioner.png)
...
![Local Path Provisioner workflow](local-path-provisioner.png)
