...
- You have full control towards the IP that you use. The IP will be may belongs to your ASN instead of cloud provider's ASN.
...
![enter image description here](kubernete-external-ip-demo.png)
...
![Floating IP setup](kubernetes-floating-ip.png)
