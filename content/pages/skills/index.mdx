...
- Flask
- [Golang Echo (non-production)](https://github.com/sdil/learning/tree/master/go)
- Java Spring (legacy system)

I have a little experience writing web frontend using:

- [VueJS & NuxtJS](https://fadhil-blog.dev/my-journey-to-relearn-java-script-after-so-many-years-and-how-you-can-start-too)
- jQuery
...
- [RabbitMQ](https://fadhil-blog.dev/an-introduction-to-message-queues-with-rabbit-mq-and-python)
...
- Amazon Web Service (EC2, ECS, RDS, S3, VPC & Route53)
- PosgreSQL
